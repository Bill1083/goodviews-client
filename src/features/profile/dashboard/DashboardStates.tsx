...
/** Mirrors the loaded layout (hub card, six tiles, the Taste DNA card) so the
 * page doesn't jump when the numbers arrive. */
export function DashboardSkeleton() {
  return (
    <div className="flex flex-col gap-4" aria-busy="true" aria-label="Loading your taste profile">
...
export function EmptyDashboard() {
  return (
    <section className="flex flex-col items-center gap-3 rounded-2xl border border-dashed border-white/15 bg-navy-card/40 px-6 py-10 text-center">
      ...
      <p className="max-w-sm text-sm text-gray-muted">Rate your first film and we'll start mapping what you love, genre by genre.</p>
